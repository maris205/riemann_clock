...
- 报告生成 UTC：2026-09-20T17:41:16.215482+00:00。时间戳采用计算环境时钟。
...
| 阶段 | 数量 | 含义 |
|---|---:|---|
| 主目录行数 | 475 | 包括没有最终合并谱的行 |
| 有最终光谱的类星体 | 467 | 不是 467 个精密常数测量 |
| DLA 视线／吸收系统 | 132／155 | 同一视线可能有多个吸收红移 |
| 通过初步目录条件的吸收系统 | 36 | 覆盖、代理 CNR、森林及主要大气带条件 |
| 实际下载的不同视线 | 32 | 全部初筛合格系统；下载失败 0 |
| 实际 Fe II 谱线窗口 | 324 | 每个系统 9 条跃迁，保留全部排除原因 |
| 排除论文列出全部宽水汽带后的目录候选 | 7 | 保守条件会舍弃某些实际可用窄区间 |
| 通过原生像素质量与共同吸收条件 | 6 | 进入气体模型开发的候选，非已验证物理变化 |

下载归档文件合计 **194.65 MB**。档案为历史曝光经原作者归一化、合并的高分辨率光谱；不是 2026 年新取得的光子观测。波长、归一化流量、误差、预期波动、像素状态和贡献记录均已读取，未对原生数据重新采样。
...
|---|---:|---|---|---|
| J232128-105122 | 1.629 | 2344, 2374, 2382, 2586 | 2374, 2586 | 未触发固定阈值 |
| J225719-100104 | 1.836 | 2344, 2374, 2382 | 2374 | 2344, 2374, 2382 |
| J053007-250329 | 2.141 | 1608, 2374, 2382 | 2374 | 未触发固定阈值 |
| J233156-090802 | 2.143 | 1608, 2374, 2382 | 2374 | 1608, 2374, 2382 |
| J004131-493611 | 2.248 | 1608, 2374, 2382 | 2374 | 未触发固定阈值 |
| J064326-504112 | 2.659 | 1608, 2374, 2382 | 2374 | 1608 |
