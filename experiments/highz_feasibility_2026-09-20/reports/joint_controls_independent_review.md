...
- Verification status: PASS；590/590 项检查通过。
- Final comparisons available: True；selected optimizer termination flags: True。
- Scope: 保存结果和代数重算为 VERIFIED；全局优化、噪声迁移的物理有效性及宇宙时间解释不在数值认证范围内。
- UTC: 2026-09-20T17:31:41.056668+00:00
...
|---|---|---|---:|---:|---:|---|
| core01_gls | `core01_gls_null` | `core01_gls_alternative_cross` | 2692 | 5 | 23.69288989 | True |
| core03_gls | `core03_gls_null_cross` | `core03_gls_alternative` | 2473 | 5 | 6.69534445 | True |
...
|---|---:|---:|---:|---:|---:|
| core01_gls | 0.1 | ±0 | ±0.000000 | ±0 | 2692 |
| core03_gls | 0.3 | ±1 | ±1.199999 | ±3 | 2473 |

- 有限差分最大相对 L2 误差：3.78e-08。
- 协方差块最小特征值：0.368316。
- 两个掩膜合计 18 个保留像素缺口，其中 0 个缺口仍处于十阶协方差支持范围。
- 连续谱原始 lag-one 相关为 0.372639001；经 Bartlett taper 后使用 0.338762729。
- 给定误差的幅度保持原值；连续谱方差 0.704751714 没有迁移到主权重中。
